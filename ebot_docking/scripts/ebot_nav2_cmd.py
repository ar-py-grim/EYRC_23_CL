...
def main():
    ...
    goal_pose1 = create_pose_stamped(nav, 0.450, 4.55, 2.958)
    goal_pose2 = create_pose_stamped(nav, 0.426, -2.32, -1.37)
    goal_pose3 = create_pose_stamped(nav, 0.016, -0.161, 1.748)
    ...
    dock_request.orientation = 3.14  # Specify the orientation parameter
    dock_request.rack_no = "rack1"  # Specify the rack number
